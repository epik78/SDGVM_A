...
integer :: sites,yr0,yrf,snp_no,snpshts(max_years),snp_year,day,d, &
 ...
 sit_grd,co,nn1,fid,kode,imap,par_loops,gs_type
...
call read_input_file(buff1,xlatf,xlon0,xlatres,xlonres,&
 ...
 ofmt_daily,ofmt_monthly,ofmt_yearly,outyears1, outyears2,oymd,otagsn,otagsnft,snpshts,snp_no,out_cov,&
 ...
 oymdft,iofnft,sit_grd,du,narg,fire_ant,harvest_ant,met_seq)
...
!----------------------------------------------------------------------!
 ...
 xcldv,xswrv,isite,xyear0,xyearf,du,seed1,seed2,seed3,l_clim,l_stats,siteno, &

...
pft_tab(ft)%fert(6)=0.
pft_tab(ft)%fert(7)=0.
pft_tab(ft)%harvip(1)=0.
pft_tab(ft)%harvip(2)=0.
pft_tab(ft)%harvip(3)=0.
pft_tab(ft)%harvip(4)=0.
pft_tab(ft)%optlai=0.
...
do ft=1,inp%npft
 ...
 pft_tab(ft)%fert(7) = inp%pft(ft)%fert(7)
 pft_tab(ft)%harvip(1) = inp%pft(ft)%harvip(1)
 pft_tab(ft)%harvip(2) = inp%pft(ft)%harvip(2)
 pft_tab(ft)%harvip(3) = inp%pft(ft)%harvip(3)
 pft_tab(ft)%harvip(4) = inp%pft(ft)%harvip(4)
